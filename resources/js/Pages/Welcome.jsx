...
export default function Welcome({ auth }) {
    return (
        <>
            ...
            <div className="shadow-lg fixed top-0 left-0 w-screen">
                <nav className="max-w-7xl mx-auto p-6 flex justify-between">
                    <ApplicationLogo/>
            ...
            <div className="min-h-screen flex items-center max-w-7xl mx-auto pt-16">
